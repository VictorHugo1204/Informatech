            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">A melhor solução de TI para seu bolso </h1>
                    </div>
                    <p class="mb-4">Desvende o potencial ilimitado da tecnologia da informação com o curso online Informatech: mergulhe em um mundo de conhecimento e adquira habilidades técnicas essenciais para se destacar no universo digital.</p>
                    <div class="row g-0 mb-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Premiado</h5>
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Pessoal profissional</h5>
                        </div>
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Suporte 24 horas por dia</h5>
                    ...
                    <div class="d-flex align-items-center mb-4 wow fadeIn" data-wow-delay="0.6s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2">Ligue para tirarmos suas dúvidas</h5>
                            <h4 class="text-primary mb-0">(12) 9999-9999</h4>
                        </div>
                    </div>
                    <a href="index.php#planos" class="btn btn-primary py-3 px-5 mt-3 wow zoomIn" data-wow-delay="0.9s">Nossos Planos</a>
                </div>
