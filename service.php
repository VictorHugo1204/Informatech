    ...
    <!-- Navbar Start -->
        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="login.php" class="btn btn-primary py-2 px-4 ms-3">Login / Cadastro</a>              
            </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                ...
                <h1 class="mb-0">Soluções de TI personalizadas para o seu negócio de sucesso</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3"> HTML</h4>
                        <p class="m-0">O HTML é a base fundamental da web e desempenha um papel crucial na criação e exibição de conteúdo na Internet, permitindo aos desenvolvedores construir páginas web estruturadas, acessíveis e interativas.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <p class="m-0">Ele permite aos desenvolvedores controlar a aparência dos elementos, criar layouts complexos e aplicar estilos consistentes em toda a página ou site, resultando em uma experiência de usuário mais agradável e profissional.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <p class="m-0">Python é uma linguagem de programação versátil e poderosa, adequada para várias finalidades, desde desenvolvimento web até análise de dados.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <p class="m-0">PHP é uma linguagem de programação server-side voltada para o desenvolvimento de aplicativos web dinâmicos.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <p class="m-0"> Java é uma linguagem de programação popular e versátil, amplamente adotada na indústria de desenvolvimento de software.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3">Assine já!</h4>
                        <b><p class="m-0"> Gostou do que nosso curso proporciona? Garanta e assine nossos planos!</p></b>
                        <a class="btn btn-lg btn-primary rounded" href="index.php#planos">
