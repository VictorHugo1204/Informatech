...
if(!isset($_SESSION['c_nome']))        { $_SESSION['c_nome']       = null; }
if(!isset($_SESSION['c_descricao']))   { $_SESSION['c_descricao']  = null; }
if(!isset($_SESSION['c_preco']))       { $_SESSION['c_preco']      = null; }
...
<body>
	...
	<section class="py-5 my-5">
		<div class="container">
			<h1 class="mb-5">Plano Intermediário</h1>
			<div class="bg-white shadow rounded-lg d-block d-sm-flex">

                <div class="profile-tab-nav border-right">
                <img src="img\INTERMEDIARIO-.jpg" style="margin: 20px;">
				</div>

                <form action="#" method="POST">
				<div class="tab-content p-4 p-md-5" id="v-pills-tabContent">
					<div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
						<h3 class="mb-4">Informações do Plano</h3>
						<div class="row">
							<div class="col-md-6">
							...
							<div class="col-md-12">
								<div class="form-group">
                                    ...
                                    <textarea class="form-control"  rows="4" ><?php echo $_SESSION['c_descricao']; ?></textarea>								
								</div>
							</div>
							<input type="submit" name="botao" class="btn btn-primary py-2 px-4 mt-4" value="Assinar">
                        </div>
                    </div>
                </div>
                </form>
